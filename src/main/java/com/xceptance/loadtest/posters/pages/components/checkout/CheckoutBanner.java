...
public class CheckoutBanner implements Component
{
    public final static CheckoutBanner instance = new CheckoutBanner();
    ...
    public LookUpResult locate()
    {
        ...
        return Page.find().byCss(".page > h1.page-title");
    }
