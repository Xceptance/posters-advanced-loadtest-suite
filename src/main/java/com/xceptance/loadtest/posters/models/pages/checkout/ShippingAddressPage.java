...
public class ShippingAddressPage extends CheckoutPage
{
    ...
    public void validate()
    {
    	...
    	Assert.assertTrue("Expected shipping address step", checkoutProgressIndicator.isStepAvailable(2));
    }

    @Override
    public boolean is()
    {
        return super.is() && matches(has(shippingAddressForm)) && checkoutProgressIndicator.isStepAvailable(2);
    }
}